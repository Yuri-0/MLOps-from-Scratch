...
m_manager = ModelManager(endpoint='http://localhost:8000', user_id='your_id', model_name='your_models')

# Please modify the metric_name and metric freely
m_manager.log_metrics(metric_name='your_metric_name', metric=0.1)
